    ...
    return (
        <div className="w-full px-[32px] background-gradient">
            ...
            <div className="flex items-center flex-col mb-[20px]">
                ...
                <h2 className="text-[32px] font-semibold text-black">Welcome Home, Randy</h2>
            ...
            <div className="flex justify-center">
                ...
                <div className="w-[550px] bg-white m-[5px] rounded-[10px] max-h-[350px] h-[350px] border-[1px] border-[#424244]">
